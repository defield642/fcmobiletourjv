...
public class TournamentController {
 ...
 @PostMapping(value="/users/register",consumes="multipart/form-data") public ResponseEntity<?> register(@RequestParam String username,@RequestParam String location,@RequestParam String uid,@RequestPart(required=false) MultipartFile squadScreenshot){ return ResponseEntity.ok(registration.registerUser(username,location,uid,squadScreenshot)); }
